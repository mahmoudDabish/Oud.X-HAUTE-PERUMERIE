...
('11111111-1111-1111-1111-111111111111', 'Oud & Woody', 'oud-woody', 'Deep, rich, and grounding fragrances featuring luxurious oud and exotic woods.'),
('22222222-2222-2222-2222-222222222222', 'Amber & Spicy', 'amber-spicy', 'Warm, sensual, and captivating blends of amber, vanilla, and exotic spices.'),
('33333333-3333-3333-3333-333333333333', 'Floral & Elegant', 'floral-elegant', 'Sophisticated and delicate arrangements of rare roses, jasmine, and opulent blooms.'),
('44444444-4444-4444-4444-444444444444', 'Fresh & Citrus', 'fresh-citrus', 'Uplifting and vibrant compositions opening with bright citrus and fresh aromatics.');
...
-- 1. Oud Royal
('11111111-2222-3333-4444-000000000001', 'Oud Royal', 'oud-royal', 'OUD.X', 'The Crown Jewel of Fragrance', 'A majestic blend of aged Cambodian oud and velvety rose, designed for true connoisseurs.', 'Oud Royal was crafted to evoke the grandeur of ancient palaces. Every drop resonates with the deep history of Middle Eastern perfumery.', 2500, null, '11111111-1111-1111-1111-111111111111', 'Unisex', 'Extrait de Parfum', 'Woody', '12+ Hours', 'Heavy', ARRAY['Winter', 'Fall'], '100ml', 50, 'Bestseller', true, true),

-- 2. Amber Privé
('11111111-2222-3333-4444-000000000002', 'Amber Privé', 'amber-prive', 'OUD.X', 'Liquid Gold', 'A sensual and warm elixir of golden amber, Madagascan vanilla, and rare spices.', 'An intimately crafted private blend that envelops the wearer in a comforting, yet powerfully seductive aura.', 1800, 2100, '22222222-2222-2222-2222-222222222222', 'Unisex', 'Eau de Parfum', 'Oriental', '8-10 Hours', 'Moderate', ARRAY['Winter', 'Fall', 'Night'], '100ml', 30, 'Limited', true, false),

-- 3. Velvet Oud
('11111111-2222-3333-4444-000000000003', 'Velvet Oud', 'velvet-oud', 'OUD.X', 'Smooth and Seductive', 'A modern, soft interpretation of agarwood, wrapped in a blanket of cashmere wood and tonka bean.', 'Bridging the gap between ancient tradition and modern luxury, Velvet Oud is as smooth as its namesake.', 1950, null, '11111111-1111-1111-1111-111111111111', 'Men', 'Eau de Parfum', 'Woody', '8 Hours', 'Moderate', ARRAY['Fall', 'Spring'], '100ml', 100, null, false, true),
