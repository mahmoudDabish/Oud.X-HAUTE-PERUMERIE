-- ==============================================================================
-- Migration 04: Remove the 150 EGP shipping fee so delivery is 100% complimentary
-- ==============================================================================
...
BEGIN
    ...
    -- 3. Calculate Shipping (Complimentary / Free Delivery: 150 fee removed)
    v_shipping := 0;
...
-- Update any existing orders that had the 150 shipping fee added so total matches items price
UPDATE orders 
SET shipping = 0, total = subtotal - discount 
WHERE shipping = 150;
